  ...
  return (
    <footer className='w-full pt-20 pb-10 mb-[100px] md:mb-0' id='contact'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <p className='text-white-200 md:mt-10 my-5 text-center'>Reach out to me today and let&apos;s discuss how we can dfjdskalff  fjdsagoals.</p>
            ...
            <div className='w-full flex mt-16 md:flex-row flex-col justify-between items-center'>
                <p className='md:text-base text-sm md:font-normal font-light'>asfd fjdsakl  fjadskl jfds fjdals fd.</p>
